...
namespace XuReverseProxy.Core.Migrations
{
    ...
    [Migration("20240217200340_AddSourceStripAndOriginRewriteConfig")]
    partial class AddSourceStripAndOriginRewriteConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XuReverseProxy.Core.Models.DbEntity.AdminAuditLogEntry", b =>
                {
                    ...
                    b.Property<Guid?>("RelatedGlobalVariableId")
                        .HasColumnType("uuid");

                    b.Property<string>("RelatedGlobalVariableName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("XuReverseProxy.Core.Models.DbEntity.ConditionData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ProxyAuthenticationDataId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProxyAuthenticationDataId");
            ...
            modelBuilder.Entity("XuReverseProxy.Core.Models.DbEntity.GlobalVariable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XuReverseProxy.Core.Models.DbEntity.NotificationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CooldownDistinctPattern")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("LastNotifyResult")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("XuReverseProxy.Core.Models.DbEntity.ProxyConfig", b =>
                {
                    ...
                    b.Property<string>("ConditionsNotMetMessage")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("RewriteDownstreamOrigin")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("ShowConditionsNotMet")
                        .HasColumnType("boolean");

                    b.Property<string>("StaticHTML")
                        .HasColumnType("text");

                    b.Property<bool>("StripUpstreamSourceTraces")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("XuReverseProxy.Core.Models.DbEntity.ConditionData", b =>
                {
                    b.HasOne("XuReverseProxy.Core.Models.DbEntity.ProxyAuthenticationData", null)
                        .WithMany("Conditions")
                        .HasForeignKey("ProxyAuthenticationDataId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("XuReverseProxy.Core.Models.DbEntity.ProxyConfig", null)
                        .WithMany("ProxyConditions")
