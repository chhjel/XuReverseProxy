...
/// <summary>
/// https://raw.githubusercontent.com/dotnet/aspnetcore/main/src/Identity/Extensions.Core/src/Base32.cs
/// </summary>
public static class Base32
{
    ...
    public static string GenerateBase32()
    {
        ...
        return string.Create((length + 4) / 5 * 8, 0, static (buffer, _) =>
        {
            ...
            {
                int numCharsToOutput = GetNextGroup(bytes, ref offset, out byte a, out byte b, out byte c, out byte d, out byte e, out byte f, out byte g, out byte h);
