...
export default class ProxyClientIdentityService extends EFCrudServiceBase<ProxyClientIdentity> {
  ...
  public async GetPagedAsync(
    payload: ProxyClientIdentitiesPagedRequestModel,
    status: LoadStatus | null = null,
  ): Promise<PaginatedResult<ProxyClientIdentity>> {
  ...
  public async SetClientNoteAsync(
    payload: SetClientNoteRequestModel,
    status: LoadStatus | null = null,
  ...
  public async SetClientBlockedAsync(
    payload: SetClientBlockedRequestModel,
    status: LoadStatus | null = null,
  ): Promise<GenericResult> {
