...
export default class AuditLogService extends ServiceBase {
  public async GetAdminLogAsync(
    payload: GetAdminAuditLogEntriesRequestModel,
  ...
  public async GetClientLogAsync(
    payload: GetClientAuditLogEntriesRequestModel,
    status: LoadStatus | null = null,
  ): Promise<PaginatedResult<ClientAuditLogEntry>> {
