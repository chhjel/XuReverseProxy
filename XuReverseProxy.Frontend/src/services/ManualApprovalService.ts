...
export default class ManualApprovalService extends ServiceBase {
  ...
  public async SetClientBlockedAsync(
    payload: SetClientBlockedFromManualApprovalRequestMessage,
  ...
  public async SetClientNoteAsync(
    payload: SetClientNoteFromManualApprovalRequestMessage,
    status: LoadStatus | null = null,
  ): Promise<boolean> {
  ...
  public async SetClientIPBlockedAsync(
    payload: SetClientIPBlockedFromManualApprovalRequestMessage,
    status: LoadStatus | null = null,
  ): Promise<string> {
  ...
  public async RemoveIpBlockAsync(
    payload: RemoveIPBlockFromManualApprovalRequestMessage,
    status: LoadStatus | null = null,
  ): Promise<boolean> {
