...
export default class EventBus {
  ...
  private static callbacksPerEventId: {
    [key: string]: Array<RegisteredCallback>;
  } = {};

  public static on(eventId: string, callback: () => void): CallbackUnregisterShortcut {
  ...
  public static notify(eventId: string, data: any = null): void {
