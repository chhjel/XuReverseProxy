    ...
    <div class="block block--dark mt-2">
      ...
      <div class="mt-2">
        ...
        <select v-model="localValue.requestMethod" :disabled="disabled">
          <option v-for="methodOption in httpRequestMethodOptions" :value="methodOption.value">
            {{ methodOption.name }}
          </option>
        </select>
      </div>
      ...
      <code-input-component
        ...
        :readOnly="disabled"
        ref="headersEditor"
        @focus="placeholderTarget = 'headers'"
      />
      ...
      <code-input-component
        label="Body"
        v-model:value="localValue.body"
        language="json"
        class="mt-2"
        height="400px"
        :readOnly="disabled"
        ref="bodyEditor"
        @focus="placeholderTarget = 'body'"
      />
