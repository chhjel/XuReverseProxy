...
export default class ProxyConfigEditor extends Vue {
  ...
  get modeIsForward(): boolean {
    return this.localValue.mode == ProxyConfigMode.Forward;
  }
  get modeIsStaticHTML(): boolean {
    return this.localValue.mode == ProxyConfigMode.StaticHTML;
  }
}
</script>
...
<template>
  <div class="proxyconfig-edit" v-if="localValue">
    <checkbox-component
      label="Enabled"
      offLabel="Disabled"
      v-model:value="localValue.enabled"
      class="mt-1 mb-2"
      :disabled="disabled"
      warnColorOff
    />
    ...
    <div class="block block--dark mt-2" v-show="modeIsForward">
      ...
      <div class="forward-summary">
        ...
        <div class="forward-summary__content">
          <code
            ><a :href="resultingProxyUrl">{{ resultingProxyUrl }}</a></code
          >
    ...
    <div class="block block--dark mt-2" v-show="modeIsStaticHTML">
      ...
      <code-input-component
        v-model:value="localValue.staticHTML"
        language="html"
        class="mt-2"
        height="400px"
        :readOnly="disabled"
    ...
    <div class="block block--dark mt-4">
      ...
      <checkbox-component
        ...
        :disabled="disabled"
        v-model:value="localValue.showCompletedChallenges"
        class="mt-2 mb-2"
      />
      <checkbox-component
        ...
        :disabled="disabled"
        v-model:value="localValue.showChallengesWithUnmetRequirements"
        class="mt-2"
      />
    </div>
