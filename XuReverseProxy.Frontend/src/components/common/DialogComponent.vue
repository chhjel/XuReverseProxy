...
export default class DialogComponent extends Vue {
  ...
  mounted(): void {
    ...
    this.callbacks = [EventBus.on("onEscapeClicked", this.onEscapeClicked.bind(this))];
  }
  ...
  get isHideOverlay(): boolean {
    return ValueUtils.IsToggleTrue(this.hideOverlay);
  }
  get isPersistent(): boolean {
    return ValueUtils.IsToggleTrue(this.persistent);
  }
  get isSmartPersistent(): boolean {
    return ValueUtils.IsToggleTrue(this.smartPersistent);
  }
  get isFullWidth(): boolean {
    return ValueUtils.IsToggleTrue(this.fullWidth);
  }
  get isScrollableX(): boolean {
    return ValueUtils.IsToggleTrue(this.scrollableX);
  }
...
.dialog-component {
  ...
  .dialog-component_modal_wrapper {
    ...
    align-items: center;
    padding: 20px;
    animation: dialog-open 0.15s ease-in-out;
