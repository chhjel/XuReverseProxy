...
export default class LoginPage extends Vue {
  ...
  setErrorCodeStatus(): void {
    ...
    else if (this.options.errorCode == "denied")
      return this.setStatus("You do not have access to the requested page.", true);
  ...
  async createAccount(): Promise<CreateAccountResponse> {
    return await this.loginService.CreateAccountAsync(
      this.username,
      this.password,
      this.enableTotp ? this.totpSecret : "",
      this.totp,
    );
  }
  ...
  get isLoading(): boolean {
    return this.loginService.status.inProgress;
  }
  ...
  get errorOnPageLoad(): string {
    if (this.loginService.status.hasDoneAtLeastOnce) return "";
    else if (this.errorCode == "ip_changed") return LoggedOutMessageIpChanged;
    else return "";
  }
...
<template>
  <div class="login-page">
    ...
    <div class="login-form" v-if="options.isRestrictedToLocalhost">Admin login is restricted to localhost.</div>
    ...
    <div class="login-form" v-if="!options.isRestrictedToLocalhost && !options.allowCreateAdmin">
      ...
      <div class="login-form__inputs">
        ...
        <button-component v-if="isDevelopment" @click="onTestLoginClicked" :disabled="isLoading" secondary
          >Login test:test</button-component
        >
      </div>
      ...
      <div class="login-form__inputs">
        ...
        <div class="login-form__totp">
          <div v-show="enableTotp">
            ...
            <p v-if="totpSecret">
              Or optionally enter this secret manually in your app of choice:
